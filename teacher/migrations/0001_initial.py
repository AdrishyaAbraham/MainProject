    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('union', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='school.union')),
                ('upazilla', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='school.upazilla')),
            ],
        ),
        migrations.CreateModel(
            name='Designation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('religion', models.CharField(choices=[('Christianity', 'Christianity'), ('Others', 'Others')], max_length=45)),
